...
def db_start():
    ...
    cursor = db.cursor()
    book = openpyxl.open("расписание_2024/Расписание ИИТ 2 сем 23-24 уч.г на сайт.xlsx", read_only=True)  # открытие на чтение
    ...
    for sheet_name in sheets:
        ...
        while i != 200:
            ...
            for j in range(0, 4):
                try:
                    cell = sheet.cell(row=columns_pars + i, column=2)
                    fill = cell.fill
